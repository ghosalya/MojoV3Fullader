...
module mojo_top_0 (
  ...
  always @* begin
    ...
    avr_rx = 1'bz;
    io_led = 24'h000000;
    out_a[0+2-:3] = io_dip[16+0+2-:3];
    io_led[8+0+0-:1] = in_sum;
    io_led[8+1+0-:1] = in_carry;
    if (io_dip[16+0+0-:1] ^ io_dip[16+1+0-:1] ^ io_dip[16+2+0-:1] == in_sum) begin
      io_led[8+7+0-:1] = 1'h1;
    end
    if ((io_dip[16+0+0-:1] & io_dip[16+1+0-:1]) | ((io_dip[16+0+0-:1] ^ io_dip[16+1+0-:1]) & io_dip[16+2+0-:1]) == in_carry) begin
      io_led[8+6+0-:1] = 1'h1;
    end
    if (M_counter_q[0+24-:25] == 1'h0) begin
      ...
      case (M_testState_q)
        O_testState: begin
          if (in_carry == 1'h0 & in_sum == 1'h0) begin
        ...
        ABC_testState: begin
          if (in_carry == 1'h1 & in_sum == 1'h1) begin
        ...
        AC_testState: begin
          if (in_carry == 1'h1 & in_sum == 1'h0) begin
        ...
        C_testState: begin
          if (in_carry == 1'h0 & in_sum == 1'h1) begin
